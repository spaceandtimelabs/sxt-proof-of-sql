...
class BenchmarkSetting:
    def __init__(
        ...
        self.select_statement_ = (
            "select "
            + (",".join([chr(x + ord("A")) for x in range(num_result_cols)]))
            + " from T where "
            + where_expr
        )
    ...
    def plot_params(self, curr_table_length):
        return (
            str(self.base_params)
            + " --where-expr '"
            + self.where_expr
            + "'"
            + " --num-samples "
            + str(self.num_plot_samples_)
            + " --table-length "
    ...
    def callgrind_params(self):
        return (
            ...
            + "'"
            + " --num-samples "
            + str(self.num_callgrind_samples_)
            + " --table-length "
            + str(self.callgrind_table_length())
        )
