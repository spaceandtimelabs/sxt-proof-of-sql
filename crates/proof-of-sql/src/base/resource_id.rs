...
impl<'d> serde::Deserialize<'d> for ResourceId {
        ...
        D: serde::Deserializer<'d>,
    {
        ...
        ResourceId::from_str(&string).map_err(serde::de::Error::custom)
    }
}
...
impl ResourceId {
    ...
    pub fn storage_format(&self) -> String {
        ...
        let schema = schema.value.to_uppercase();
        let object_name = object_name.value.to_uppercase();
