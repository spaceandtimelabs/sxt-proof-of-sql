...
pub trait SchemaAccessor {
    ...
    fn lookup_column(&self, table_ref: TableRef, column_id: PosqlIdentifier) -> Option<ColumnType>;
    ...
    fn lookup_schema(&self, table_ref: TableRef) -> Vec<(PosqlIdentifier, ColumnType)>;
}
