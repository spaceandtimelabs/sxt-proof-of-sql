...
pub fn borrowed_tinyint<S: Scalar>(
    ...
    (name.deref().into(), Column::TinyInt(alloc_data))
}
...
pub fn borrowed_smallint<S: Scalar>(
    ...
    let alloc_data = alloc.alloc_slice_copy(&transformed_data);
    (name.deref().into(), Column::SmallInt(alloc_data))
}
...
pub fn borrowed_int<S: Scalar>(
    ...
    let alloc_data = alloc.alloc_slice_copy(&transformed_data);
    (name.deref().into(), Column::Int(alloc_data))
}
...
pub fn borrowed_bigint<S: Scalar>(
    ...
    let alloc_data = alloc.alloc_slice_copy(&transformed_data);
    (name.deref().into(), Column::BigInt(alloc_data))
}
...
pub fn borrowed_boolean<S: Scalar>(
    ...
    let alloc_data = alloc.alloc_slice_copy(&transformed_data);
    (name.deref().into(), Column::Boolean(alloc_data))
}
...
pub fn borrowed_int128<S: Scalar>(
    ...
    let alloc_data = alloc.alloc_slice_copy(&transformed_data);
    (name.deref().into(), Column::Int128(alloc_data))
}
...
pub fn borrowed_scalar<S: Scalar>(
    ...
    let alloc_data = alloc.alloc_slice_copy(&transformed_data);
    (name.deref().into(), Column::Scalar(alloc_data))
}
