...
impl<'a, S: Scalar> Column<'a, S> {
    ...
    pub(crate) fn to_scalar_with_scaling(self, scale: i8) -> Vec<S> {
        ...
        match self {
            ...
            Self::TinyInt(col) => slice_cast_with(col, |b| S::from(b) * scale_factor),
...
impl ColumnType {
    ...
    pub fn is_integer(&self) -> bool {
        matches!(
            self,
            ColumnType::SmallInt | ColumnType::Int | ColumnType::BigInt | ColumnType::Int128 | ColumnType::TinyInt
        )
    }
    ...
    pub fn scale(&self) -> Option<i8> {
        match self {
            ...
            Self::SmallInt | Self::Int | Self::BigInt | Self::Int128 | Self::Scalar | Self::TinyInt => Some(0),
            Self::Boolean | Self::VarChar => None,
    ...
    pub const fn is_signed(&self) -> bool {
        match self {
            Self::SmallInt | Self::Int | Self::BigInt | Self::Int128 | Self::TimestampTZ(_, _) | Self::TinyInt => {
                true
            }
