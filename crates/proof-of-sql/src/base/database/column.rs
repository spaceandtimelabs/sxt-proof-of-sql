...
impl ColumnType {
    ...
    pub fn is_integer(&self) -> bool {
        matches!(
            self,
            ColumnType::SmallInt | ColumnType::TinyInt |ColumnType::Int | ColumnType::BigInt | ColumnType::Int128
        )
    }
    ...
    pub fn scale(&self) -> Option<i8> {
        match self {
            ...
            Self::SmallInt | Self::TinyInt| Self::Int | Self::BigInt | Self::Int128 | Self::Scalar => Some(0),
            Self::Boolean | Self::VarChar => None,
    ...
    pub const fn is_signed(&self) -> bool {
        match self {
            Self::SmallInt | Self::TinyInt | Self::Int | Self::BigInt | Self::Int128 | Self::TimestampTZ(_, _) => {
                true
            }
...
mod tests {
    ...
    fn we_can_convert_columntype_to_json_string_and_back() {
        ...
        assert_eq!(tinyint_json, "\"Decimal\"");
        assert_eq!(
