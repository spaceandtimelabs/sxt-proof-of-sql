...
fn we_can_create_an_empty_owned_table() {
    ...
    table.insert(Identifier::new("bigint"), OwnedColumn::BigInt(vec![]));
    table.insert(Identifier::new("decimal"), OwnedColumn::Int128(vec![]));
    table.insert(Identifier::new("varchar"), OwnedColumn::VarChar(vec![]));
    table.insert(Identifier::new("scalar"), OwnedColumn::Scalar(vec![]));
    table.insert(Identifier::new("boolean"), OwnedColumn::Boolean(vec![]));
