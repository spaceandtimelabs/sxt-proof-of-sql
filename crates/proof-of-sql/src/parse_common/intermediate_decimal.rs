...
use snafu::Snafu;
use crate::parse_common::intermediate_decimal::IntermediateDecimalError::ParseError;
...
impl IntermediateDecimal {
    ...
    pub fn precision(&self) -> u8 {
        u8::try_from(self.value.digits()).unwrap_or_else(|_| u8::MAX)
    }

    /// Get the scale of the fixed-point representation of this intermediate decimal.
    #[must_use]
    pub fn scale(&self) -> i8 {
        i8::try_from(self.value.fractional_digit_count()).unwrap_or_else(|_| i8::MAX)
    }
    ...
    pub fn try_into_bigint_with_precision_and_scale(
        ...
        if scaled_decimal.digits() > precision.into() {
            return Err(IntermediateDecimalError::LossyCast);
        }
...
impl TryFrom<IntermediateDecimal> for i128 {
    ...
    fn try_from(decimal: IntermediateDecimal) -> Result<Self, Self::Error> {
        ...
        match decimal.value.to_i128() {
            ...
            _ => Err(IntermediateDecimalError::OutOfRange),
        }
    }
}
...
mod tests {
    ...
    fn test_conversion_to_i128() {
        ...
        assert_eq!(i128::try_from(overflow_decimal), Err(IntermediateDecimalError::OutOfRange));
        ...
        assert_eq!(i128::try_from(non_integer), Err(IntermediateDecimalError::LossyCast));
    }
    ...
    fn test_conversion_to_i64() {
        ...
        assert_eq!(i64::try_from(overflow_decimal), Err(IntermediateDecimalError::OutOfRange));
        ...
        assert_eq!(i64::try_from(non_integer), Err(IntermediateDecimalError::LossyCast));
    }
}
