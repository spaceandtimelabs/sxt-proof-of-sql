use super::{
    hyrax_configuration::HyraxConfiguration, hyrax_helpers::row_and_column_from_index,
    hyrax_public_setup::HyraxPublicSetup, hyrax_scalar::HyraxScalarWrapper,
};
use crate::base::{
    ...
    for<'b> C::OperableGroup: 'b,
{
    fn compute_hyrax_commitment(
        ...
        .map(|index| {
            ...
            (row, setup.generators[column] * scalar_column[index])
        })
        .collect::<Vec<_>>()
        .into_iter()
