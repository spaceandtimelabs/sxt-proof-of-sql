...
pub struct SumcheckMleEvaluations<'a, S: Scalar> {
    ...
    /// The evaluation (at the random point generated by sumcheck) of the MLE formed from the all one column.
    pub range_length_one_evaluation: S,
...
impl<'a, S: Scalar> SumcheckMleEvaluations<'a, S> {
    ...
    pub fn new(
        ...
        let range_length_one_evaluation =
            compute_truncated_lagrange_basis_sum(range_length, evaluation_point);
        Self {
            num_sumcheck_variables: evaluation_point.len(),
            one_evaluations,
            singleton_one_evaluation,
            range_length_one_evaluation,
            random_evaluation,
