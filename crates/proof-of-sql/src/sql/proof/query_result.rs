    ...
    fn from(error: TableCoercionError) -> Self {
        match error {
            ...
            TableCoercionError::ColumnCoercionError {
                ...
                error: "Invalid Type Coercion",
            }
            .into(),
            TableCoercionError::NameMismatch => ProofError::VerificationError {
                error: "Field Names Mismatch",
            }
            .into(),
            TableCoercionError::ColumnCountMismatch => ProofError::VerificationError {
