...
fn we_can_slice_a_table_with_null_values_following_sql_three_valued_logic() {
    ...
    use crate::sql::postprocessing::test_utility::slice;
    ...
    let c_values = varchar_values::<Curve25519Scalar>(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J"]);
    ...
    let b_ints = match &b_values {
        OwnedColumn::Int(values) => values,
