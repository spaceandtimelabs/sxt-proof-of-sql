...
fn we_can_chain_expressions() {
    ...
    let result_expr = composite_result(Box::new(composition));
...
fn the_order_that_we_chain_expressions_is_relevant() {
    ...
    let result_expr1 = composite_result(Box::new(composition1));
    ...
    let result_expr2 = composite_result(Box::new(composition2));
