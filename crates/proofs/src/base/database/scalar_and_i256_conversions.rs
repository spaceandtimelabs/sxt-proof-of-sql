...
mod tests {
    ...
    fn test_arkscalar_i256_overflow_and_underflow() {
        ...
        assert!(ArkScalar::try_from(MAX_SUPPORTED_I256 + i256::from(1)).is_err());
        ...
        assert!(ArkScalar::try_from(MIN_SUPPORTED_I256 - i256::from(1)).is_err());
    }
    ...
    fn test_i256_arkscalar_max_signed() {
        ...
        let i256_arkscalar = ArkScalar::try_from(max_signed);
    ...
    fn test_i256_arkscalar_min_signed() {
        ...
        let i256_arkscalar = ArkScalar::try_from(min_signed);
        // -MAX_SIGNED is ok
        assert!(i256_arkscalar.is_ok());
        assert_eq!(
