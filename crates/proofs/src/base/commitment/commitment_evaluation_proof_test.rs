...
pub fn test_simple_commitment_evaluation_proof<CP: CommitmentEvaluationProof>(
    ...
    let commits = CP::VecCommitment::from_columns_with_offset(
        &[Column::Scalar(&[
            CP::Scalar::one(),
...
pub fn test_commitment_evaluation_proof_with_length_1<CP: CommitmentEvaluationProof>(
    ...
    let commits =
        CP::VecCommitment::from_columns_with_offset(&[Column::Scalar(&[r])], 0, prover_setup)
            .to_decompressed()
            .unwrap();
...
pub fn test_random_commitment_evaluation_proof<CP: CommitmentEvaluationProof>(
    ...
    let commits =
        CP::VecCommitment::from_columns_with_offset(&[Column::Scalar(&a)], offset, prover_setup)
            .to_decompressed()
            .unwrap();
