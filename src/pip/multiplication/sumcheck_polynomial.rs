...
pub fn make_sumcheck_polynomial(
    ...
    let fb = Rc::new(DenseMultilinearExtension::from_evaluations_slice(
        num_vars, b_vec,
    ));
    let fab = Rc::new(DenseMultilinearExtension::from_evaluations_slice(
        num_vars, ab_vec,
    ));
    let fr = Rc::new(DenseMultilinearExtension::from_evaluations_slice(
        num_vars, r_vec,
    ));
